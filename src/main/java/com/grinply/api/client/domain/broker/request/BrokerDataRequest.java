package com.grinply.api.client.domain.broker.request;

import com.grinply.api.client.domain.broker.BusinessType;
import com.grinply.api.client.domain.broker.WithUsedAmount;

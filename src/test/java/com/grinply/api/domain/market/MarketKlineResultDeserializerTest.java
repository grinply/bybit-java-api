...
import com.grinply.api.client.domain.market.response.kline.MarketKlineEntry;
import com.grinply.api.client.domain.market.response.kline.MarketKlineResult;
